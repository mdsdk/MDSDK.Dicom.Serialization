...
{
    public class OtherBinaryEncodedPrimitiveValue<T> : BinaryEncodedPrimitiveValueBase<T>, ISingleValue<T[]>, IHas32BitExplicitVRLength, IMayHaveUndefinedLength where T : struct, IFormattable
    {
